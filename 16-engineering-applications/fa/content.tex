...
\item
  \textbf{چرا گاوسی؟} \lr{CLT} \lr{—} نویز حرارتی جمع سهم‌های بسیاری از الکترون‌ها است
\item
...
\tightlist
\item
  پوش \lr{\textbar{}}\lr{h\textbar{} \textasciitilde{} Rayleigh(\ensuremath{\sigma})}
\item
  توان \lr{\textbar{}}\lr{h\textbar{}\textsuperscript{2} \textasciitilde{} Exponential(1/(2\ensuremath{\sigma}\textsuperscript{2}))}
\item
...
\textbf{میانگین \lr{BER} در محوشدگی:}\PSdisplay{\bar{P}_e = \int_0^\infty P_e(\gamma) \cdot f_\gamma(\gamma) \, d\gamma}
...
برای رواداری \lr{\ensuremath{\pm}5\%} (\PSnum{99.7\%} در محدوده): \lr{3\ensuremath{\sigma} = 0.05R\textsubscript{0} \ensuremath{\to} \ensuremath{\sigma} = 0.0167R\textsubscript{0}}
...
پرسش طراحی: چه ظرفیت \lr{C} تضمین می‌کند \lr{P(\rl{بار} \textgreater{} \rl{ظرفیت}) \textless{} 0.01}؟
