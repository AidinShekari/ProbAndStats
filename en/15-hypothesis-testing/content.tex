...
\tightlist
\item
  Reject if \textbar{}T\textbar{} \textgreater{} t\_\{\ensuremath{\alpha}/2, n-1\}
\item
...
\tightlist
\item
  H\textsubscript{1}: \ensuremath{\mu} \textgreater{} \ensuremath{\mu}\textsubscript{0}: Reject if T \textgreater{} t\_\{\ensuremath{\alpha}, n-1\}
\item
  H\textsubscript{1}: \ensuremath{\mu} \textless{} \ensuremath{\mu}\textsubscript{0}: Reject if T \textless{} -t\_\{\ensuremath{\alpha}, n-1\}
\end{itemize}
...
\tightlist
\item
  H\textsubscript{1}: \ensuremath{\sigma}\textsuperscript{2} \textgreater{} \ensuremath{\sigma}\textsubscript{0}\textsuperscript{2}: Reject if \ensuremath{\chi}\textsuperscript{2} \textgreater{} \ensuremath{\chi}\textsuperscript{2}\_\{\ensuremath{\alpha}, n-1\}
\item
  H\textsubscript{1}: \ensuremath{\sigma}\textsuperscript{2} \ensuremath{\neq} \ensuremath{\sigma}\textsubscript{0}\textsuperscript{2}: Reject if \ensuremath{\chi}\textsuperscript{2} \textless{} \ensuremath{\chi}\textsuperscript{2}\_\{1-\ensuremath{\alpha}/2, n-1\} or \ensuremath{\chi}\textsuperscript{2} \textgreater{} \ensuremath{\chi}\textsuperscript{2}\_\{\ensuremath{\alpha}/2, n-1\}
\end{itemize}
...
t\_\{0.025, 19\} = 2.093. Since \textbar{}T\textbar{} = 1.789 \textless{} 2.093 \ensuremath{\to} \textbf{Fail to reject H\textsubscript{0}.}
...
t\_\{0.025, 29\} = 2.045. \textbar{}T\textbar{} = 1.878 \textless{} 2.045 \ensuremath{\to} \textbf{Fail to reject H\textsubscript{0}.}
...
\ensuremath{\chi}\textsuperscript{2}\_\{0.05, 24\} = 36.415. Since 34.8 \textless{} 36.415 \ensuremath{\to} \textbf{Fail to reject H\textsubscript{0}.}
