...
\PSsection{8.2}{Conditional Expectation E[X\textbar{}Y=y]}

\begin{PSbox}[unbreakable]{def}{Definition}

\textbf{Continuous:}\PSbr{}\[E[X|Y=y] = \int_{-\infty}^{\infty} x \cdot f_{X|Y}(x|y) \, dx\]

\textbf{Discrete:}\PSbr{}\[E[X|Y=y] = \sum_x x \cdot p_{X|Y}(x|y)\]

\end{PSbox}

\PSsubsection{Interpretation}

E[X\textbar{}Y=y] is the \textbf{average value of X} when we know Y = y. It is a function of y.

\PSsubsection{E[X\textbar{}Y] as a Random Variable}

When Y is itself random, E[X\textbar{}Y] is a \textbf{random variable} — it takes the value E[X\textbar{}Y=y] when Y = y.
...
\tightlist
\item
  Good channel (Y=1): E[P\textbar{}Y=1] = 10 mW
\item
  Poor channel (Y=0): E[P\textbar{}Y=0] = 1 mW
\item
  P(Y=1) = 0.7, P(Y=0) = 0.3
\end{itemize}
...
\PSsection{8.3}{Conditional Variance Var(X\textbar{}Y=y)}
...
\tightlist
\item
  At T=20\ensuremath{^{\circ}}C: Var(X\textbar{}T=20) = 0.01 (high precision)
\item
  At T=80\ensuremath{^{\circ}}C: Var(X\textbar{}T=80) = 0.09 (low precision due to thermal effects)
\end{itemize}
...
\textbf{Discrete version:}\PSbr{}\[E[X] = \sum_y E[X|Y=y] \cdot P(Y=y)\]

\textbf{Continuous version:}\PSbr{}\[E[X] = \int_{-\infty}^{\infty} E[X|Y=y] \cdot f_Y(y) \, dy\]

\PSsubsection{Proof (Discrete)}

E[E[X\textbar{}Y]] = \ensuremath{\Sigma}\textsubscript{y} E[X\textbar{}Y=y] \ensuremath{\cdot} P(Y=y)\PSbr{}= \ensuremath{\Sigma}\textsubscript{y} [\ensuremath{\Sigma}\textsubscript{x} x \ensuremath{\cdot} P(X=x\textbar{}Y=y)] \ensuremath{\cdot} P(Y=y)\PSbr{}= \ensuremath{\Sigma}\textsubscript{x} \ensuremath{\Sigma}\textsubscript{y} x \ensuremath{\cdot} P(X=x, Y=y)\PSbr{}= \ensuremath{\Sigma}\textsubscript{x} x \ensuremath{\cdot} P(X=x) = E[X] \PSyes{}
...
\tightlist
\item
  Mode 1 (60\% of time): BER = 10\textsuperscript{-6}
\item
  Mode 2 (30\% of time): BER = 10\textsuperscript{-4}
\item
  Mode 3 (10\% of time): BER = 10\textsuperscript{-2}
\end{itemize}

Overall BER = E[BER] = 0.6(10\textsuperscript{-6}) + 0.3(10\textsuperscript{-4}) + 0.1(10\textsuperscript{-2})\PSbr{}= 0.6\ensuremath{\times}10\textsuperscript{-6} + 30\ensuremath{\times}10\textsuperscript{-6} + 10000\ensuremath{\times}10\textsuperscript{-6} \ensuremath{\approx} 1.003 \ensuremath{\times} 10\textsuperscript{-3}
...
\tightlist
\item
  Defect-free: E[T\textbar{}good] = 10000 hours
\item
  With defect: E[T\textbar{}defect] = 500 hours
\end{itemize}
...
E[Var(X\textbar{}Y)] & Expected conditional variance & Average ``within-group'' variability \\
Var(E[X\textbar{}Y]) & Variance of conditional means & ``Between-group'' variability \\
\end{longtable}
}

\PSsubsection{Proof}

Var(X) = E[X\textsuperscript{2}] - (E[X])\textsuperscript{2}

E[X\textsuperscript{2}] = E[E[X\textsuperscript{2}\textbar{}Y]] (tower property)\PSbr{}= E[Var(X\textbar{}Y) + (E[X\textbar{}Y])\textsuperscript{2}]\PSbr{}= E[Var(X\textbar{}Y)] + E[(E[X\textbar{}Y])\textsuperscript{2}]

(E[X])\textsuperscript{2} = (E[E[X\textbar{}Y]])\textsuperscript{2}

Var(X) = E[Var(X\textbar{}Y)] + E[(E[X\textbar{}Y])\textsuperscript{2}] - (E[E[X\textbar{}Y]])\textsuperscript{2}\PSbr{}= E[Var(X\textbar{}Y)] + Var(E[X\textbar{}Y]) \PSyes{}
...
\tightlist
\item
  Indoor: E[X\textbar{}Y=1] = 25\ensuremath{^{\circ}}C, Var(X\textbar{}Y=1) = 1
\item
  Outdoor: E[X\textbar{}Y=2] = 15\ensuremath{^{\circ}}C, Var(X\textbar{}Y=2) = 16
\end{itemize}

\textbf{E[Var(X\textbar{}Y)]} = 0.6(1) + 0.4(16) = 7.0 (average within-condition variance)

\textbf{Var(E[X\textbar{}Y])} = E[(E[X\textbar{}Y])\textsuperscript{2}] - (E[E[X\textbar{}Y]])\textsuperscript{2}\PSbr{}= 0.6(25\textsuperscript{2}) + 0.4(15\textsuperscript{2}) - [0.6(25) + 0.4(15)]\textsuperscript{2} = 375 + 90 - (21)\textsuperscript{2} = 465 - 441 = 24

\textbf{Var(X)} = 7.0 + 24.0 = 31.0
...
\tightlist
\item
  Type A (prob 0.7): E[delay\textbar{}A] = 5ms, Var(delay\textbar{}A) = 2
\item
  Type B (prob 0.3): E[delay\textbar{}B] = 20ms, Var(delay\textbar{}B) = 25
\end{itemize}
...
\item
  E[Var(D\textbar{}type)] = 0.7(2) + 0.3(25) = 1.4 + 7.5 = 8.9\PSbr{}Var(E[D\textbar{}type]) = 0.7(5\textsuperscript{2}) + 0.3(20\textsuperscript{2}) - 9.5\textsuperscript{2} = 17.5 + 120 - 90.25 = 47.25\PSbr{}Var(D) = 8.9 + 47.25 = 56.15
\end{enumerate}
...
A random number N of components are tested. N \textasciitilde{} Poisson(10). Each has independent failure probability p=0.05. Let X = number of failures. Find E[X] and Var(X).

\PSsolution{} X\textbar{}N \textasciitilde{} Binomial(N, 0.05). E[X\textbar{}N] = 0.05N. Var(X\textbar{}N) = N(0.05)(0.95) = 0.0475N.\PSbr{}E[X] = E[E[X\textbar{}N]] = E[0.05N] = 0.05(10) = 0.5\PSbr{}Var(X) = E[Var(X\textbar{}N)] + Var(E[X\textbar{}N]) = E[0.0475N] + Var(0.05N) = 0.0475(10) + 0.05\textsuperscript{2}(10) = 0.475 + 0.025 = 0.5
