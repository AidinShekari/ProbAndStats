...
\textbf{Discrete:}\PSbr{}\[E[g(X)] = \sum_{x} g(x) \cdot p_X(x)\]

\textbf{Continuous:}\PSbr{}\[E[g(X)] = \int_{-\infty}^{\infty} g(x) \cdot f_X(x) \, dx\]
...
If X and Y are independent:\PSbr{}\[E[XY] = E[X] \cdot E[Y]\]
...
\textbf{SNR (Signal-to-Noise Ratio):}\PSbr{}\[\text{SNR} = \frac{E[S^2]}{\sigma_N^2} = \frac{\text{Signal Power}}{\text{Noise Power}}\]
