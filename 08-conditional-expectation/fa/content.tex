...
\lr{E[Var(X\textbar{}Y)]} & واریانس شرطی مورد انتظار & تغییرپذیری «درون‌گروهی» میانگین \\
\lr{Var(E[X\textbar{}Y])} & واریانس میانگین‌های شرطی & تغییرپذیری «بین‌گروهی» \\
\end{longtable}
}
...
\tightlist
\item
  نوع \lr{A} (احتمال \PSnum{0.7}): \lr{E[delay\textbar{}A] = 5ms}، \lr{Var(delay\textbar{}A) = 2}
\item
  نوع \lr{B} (احتمال \PSnum{0.3}): \lr{E[delay\textbar{}B] = 20ms}، \lr{Var(delay\textbar{}B) = 25}
\end{itemize}
...
\emph{ماژول بعدی: {ماژول 9 \lr{—} کوواریانس و همبستگی}}\PSbr{}
