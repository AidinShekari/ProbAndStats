...
\PSsection{8.2}{امید ریاضی شرطی \lr{\mbox{E[X\textbar{}Y=y]}}}
...
\lr{\mbox{E[X\textbar{}Y=y]}} همان \textbf{مقدار میانگین \lr{\mbox{X}}} است هنگامی که \lr{\mbox{Y = y}} را می‌دانیم. این تابعی از \lr{\mbox{y}} است.

\PSsubsection{\lr{\mbox{E[X\textbar{}Y]}} به‌عنوان یک متغیر تصادفی}

هنگامی که خود \lr{\mbox{Y}} تصادفی باشد، \lr{\mbox{E[X\textbar{}Y]}} یک \textbf{متغیر تصادفی} است \lr{—} وقتی \lr{\mbox{Y = y}} باشد مقدار \lr{\mbox{E[X\textbar{}Y=y]}} را اختیار می‌کند.
...
\tightlist
\item
  کانال خوب \lr{\mbox{(Y=1)}}: \lr{\mbox{E[P\textbar{}Y=1] = 10 mW}}
\item
  کانال ضعیف \lr{\mbox{(Y=0)}}: \lr{\mbox{E[P\textbar{}Y=0] = 1 mW}}
\item
  \lr{\mbox{P(Y=1) = 0.7}}، \lr{\mbox{P(Y=0) = 0.3}}
\end{itemize}

\end{PSbox}

\PSsection{8.3}{واریانس شرطی \lr{\mbox{Var(X\textbar{}Y=y)}}}
...
واریانس شرطی \textbf{عدم‌قطعیت باقی‌مانده در \lr{\mbox{X}}} را پس از معلوم‌شدن \lr{\mbox{Y}} می‌سنجد.
...
\tightlist
\item
  در \lr{\mbox{T=20\ensuremath{^{\circ}}C}}: \lr{\mbox{Var(X\textbar{}T=20) = 0.01}} (دقت بالا)
\item
  در \lr{\mbox{T=80\ensuremath{^{\circ}}C}}: \lr{\mbox{Var(X\textbar{}T=80) = 0.09}} (دقت پایین به‌دلیل اثرهای گرمایی)
\end{itemize}
...
\tightlist
\item
  حالت 1 (60\% زمان): \lr{\mbox{BER = 10\textsuperscript{-6}}}
\item
  حالت 2 (30\% زمان): \lr{\mbox{BER = 10\textsuperscript{-4}}}
\item
  حالت 3 (10\% زمان): \lr{\mbox{BER = 10\textsuperscript{-2}}}
\end{itemize}

\lr{\mbox{BER}} کل = \lr{E[BER] = 0.6(10\textsuperscript{-6}) + 0.3(10\textsuperscript{-4}) + 0.1(10\textsuperscript{-2})}\PSbr{}\lr{= 0.6\ensuremath{\times}10\textsuperscript{-6} + 30\ensuremath{\times}10\textsuperscript{-6} + 10000\ensuremath{\times}10\textsuperscript{-6} \ensuremath{\approx} 1.003 \ensuremath{\times} 10\textsuperscript{-3}}
...
\tightlist
\item
  بدون نقص: \lr{\mbox{E[T\textbar{}good] = 10000}} ساعت
\item
  با نقص: \lr{\mbox{E[T\textbar{}defect] = 500}} ساعت
\end{itemize}

\lr{\mbox{E[T] = 0.9(10000) + 0.1(500) = 9050}} ساعت
...
\bottomrule\noalign{}
\endlastfoot
\lr{\mbox{Var(X)}} & واریانس کل & عدم‌قطعیت کل در \lr{\mbox{X}} \\
\lr{\mbox{E[Var(X\textbar{}Y)]}} & واریانس شرطی مورد انتظار & تغییرپذیری «درون‌گروهی» میانگین \\
\lr{\mbox{Var(E[X\textbar{}Y])}} & واریانس میانگین‌های شرطی & تغییرپذیری «بین‌گروهی» \\
\end{longtable}
}
...
\lr{Var(X) = E[Var(X\textbar{}Y)] + E[(E[X\textbar{}Y])\textsuperscript{2}] - (E[E[X\textbar{}Y]])\textsuperscript{2}}\PSbr{}\lr{\mbox{= E[Var(X\textbar{}Y)] + Var(E[X\textbar{}Y]) \PSyes{}}}
...
یک حسگر در فضای بسته (\lr{\mbox{Y=1}}، احتمال \PSnum{0.6)} و فضای باز (\lr{\mbox{Y=2}}، احتمال \PSnum{0.4)} کار می‌کند:

\begin{itemize}
\tightlist
\item
  فضای بسته: \lr{\mbox{E[X\textbar{}Y=1] = 25\ensuremath{^{\circ}}C}}، \lr{\mbox{Var(X\textbar{}Y=1) = 1}}
\item
  فضای باز: \lr{\mbox{E[X\textbar{}Y=2] = 15\ensuremath{^{\circ}}C}}، \lr{\mbox{Var(X\textbar{}Y=2) = 16}}
\end{itemize}

\lr{\textbf{\lr{\mbox{E[Var(X\textbar{}Y)]}}} = 0.6(1) + 0.4(16) = 7.0} (میانگین واریانس درون‌شرطی)

\lr{\textbf{\lr{\mbox{Var(E[X\textbar{}Y])}}} = E[(E[X\textbar{}Y])\textsuperscript{2}] - (E[E[X\textbar{}Y]])\textsuperscript{2}}\PSbr{}\lr{= 0.6(25\textsuperscript{2}) + 0.4(15\textsuperscript{2}) - [0.6(25) + 0.4(15)]\textsuperscript{2} = 375 + 90 - (21)\textsuperscript{2} = 465 - 441 = 24}

\lr{\mbox{\textbf{\lr{\mbox{Var(X)}}} = 7.0 + 24.0 = 31.0}}
...
\tightlist
\item
  نوع \lr{\mbox{A}} (احتمال \PSnum{0.7}): \lr{\mbox{E[delay\textbar{}A] = 5ms}}، \lr{\mbox{Var(delay\textbar{}A) = 2}}
\item
  نوع \lr{\mbox{B}} (احتمال \PSnum{0.3}): \lr{\mbox{E[delay\textbar{}B] = 20ms}}، \lr{\mbox{Var(delay\textbar{}B) = 25}}
\end{itemize}

موارد زیر را بیابید: (الف) \lr{\mbox{E[delay]}}، (ب) \lr{\mbox{Var(delay)}}.
...
\item
  \lr{E[Var(D\textbar{}type)] = 0.7(2) + 0.3(25) = 1.4 + 7.5 = 8.9}\PSbr{}\lr{Var(E[D\textbar{}type]) = 0.7(5\textsuperscript{2}) + 0.3(20\textsuperscript{2}) - 9.5\textsuperscript{2} = 17.5 + 120 - 90.25 = 47.25}\PSbr{}\lr{\mbox{Var(D) = 8.9 + 47.25 = 56.15}}
\end{enumerate}
...
تعداد تصادفی \lr{\mbox{N}} از قطعات آزمایش می‌شوند. \lr{\mbox{N \textasciitilde{} Poisson(10)}}. هر قطعه احتمال خرابی مستقل \lr{\mbox{p=0.05}} دارد. فرض کنید \lr{\mbox{X}} = تعداد خرابی‌ها. \lr{\mbox{E[X]}} و \lr{\mbox{Var(X)}} را بیابید.

\PSsolution{} \lr{\mbox{X\textbar{}N \textasciitilde{} Binomial(N, 0.05)}}. \lr{\mbox{E[X\textbar{}N] = 0.05N}}. \lr{\mbox{Var(X\textbar{}N) = N(0.05)(0.95) = 0.0475N}}.\PSbr{}\lr{\mbox{E[X] = E[E[X\textbar{}N]] = E[0.05N] = 0.05(10) = 0.5}}\PSbr{}\lr{Var(X) = E[Var(X\textbar{}N)] + Var(E[X\textbar{}N]) = E[0.0475N] + Var(0.05N) = 0.0475(10) + 0.05\textsuperscript{2}(10) = 0.475 + 0.025 = 0.5}
