...
where \ensuremath{\Gamma}(\ensuremath{\alpha}) = (\ensuremath{\alpha}-1)! for integer \ensuremath{\alpha}, and \ensuremath{\Gamma}(\ensuremath{\alpha}) = \ensuremath{\int}\textsubscript{0}\textsuperscript{\ensuremath{\infty}} t\textsuperscript{(\ensuremath{\alpha}-1)e}(-t)dt in general.
