...
Solving for \ensuremath{\mu}:\PSdisplay{P\left(\bar{X} - z_{\alpha/2}\frac{\sigma}{\sqrt{n}} \leq \mu \leq \bar{X} + z_{\alpha/2}\frac{\sigma}{\sqrt{n}}\right) = 1 - \alpha}
...
95\% CI: t\textsubscript{0.025, 14} = 2.145
...
95\% CI for \ensuremath{\sigma}\textsuperscript{2}: \ensuremath{\chi}\textsuperscript{2}\textsubscript{0.025, 19} = 32.852, \ensuremath{\chi}\textsuperscript{2}\textsubscript{0.975, 19} = 8.907
