...
\textbf{Mean of \ensuremath{\bar{X}}:}\PSdisplay{E[\bar{X}] = \mu}

\ensuremath{\bar{X}} is an \textbf{unbiased} estimator of \ensuremath{\mu} (on average, it equals the truth).

\textbf{Variance of \ensuremath{\bar{X}}:}\PSdisplay{\text{Var}(\bar{X}) = \frac{\sigma^2}{n}}
...
If population is N(\ensuremath{\mu}, \ensuremath{\sigma}\textsuperscript{2}):\PSdisplay{(n-1)S^2/\sigma^2 \sim \chi^2(n-1)}
