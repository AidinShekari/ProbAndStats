...
برای \lr{X\textsubscript{1}, X\textsubscript{2}, …, X\textsubscript{n}}:\PSdisplay{f_{X_1,...,X_n}(x_1,...,x_n) \geq 0, \quad \int\cdots\int f_{X_1,...,X_n} \, dx_1 \cdots dx_n = 1}
...
\lr{X\textsubscript{1}, …, X\textsubscript{n}} به‌طور متقابل مستقل هستند اگر:\PSdisplay{f_{X_1,...,X_n}(x_1,...,x_n) = \prod_{i=1}^n f_{X_i}(x_i)}
...
که در آن \lr{\textbar{}}\lr{\ensuremath{\Sigma}}\lr{\textbar{}} = دترمینان \lr{\ensuremath{\Sigma}}.
...
\emph{ماژول بعدی: {ماژول \lr{11} \lr{—} قضیه حد مرکزی}}\PSbr{}
