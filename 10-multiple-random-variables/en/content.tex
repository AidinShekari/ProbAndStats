...
For X\textsubscript{1}, X\textsubscript{2}, …, X\textsubscript{n}:\PSdisplay{f_{X_1,...,X_n}(x_1,...,x_n) \geq 0, \quad \int\cdots\int f_{X_1,...,X_n} \, dx_1 \cdots dx_n = 1}
...
X\textsubscript{1}, …, X\textsubscript{n} are mutually independent if:\PSdisplay{f_{X_1,...,X_n}(x_1,...,x_n) = \prod_{i=1}^n f_{X_i}(x_i)}
