...
For continuous RVs X, Y, the joint PDF f\textsubscript{X,Y}(x,y) satisfies:\PSdisplay{P((X,Y) \in A) = \iint_A f_{X,Y}(x,y) \, dx \, dy}
...
Joint PDF: f\textsubscript{X,Y}(x,y) = 2e\textsuperscript{-x}e\textsuperscript{-2y}, x \ensuremath{\ge} 0, y \ensuremath{\ge} 0
...
\tightlist
\item
  f\textsubscript{X}(x) = \ensuremath{\int}\textsubscript{0}\textsuperscript{\ensuremath{\infty}} 2e\textsuperscript{-x}e\textsuperscript{-2y} dy = 2e\textsuperscript{-x} \ensuremath{\cdot} [1/2] = e\textsuperscript{-x} \ensuremath{\to} X \textasciitilde{} Exp(1)
\item
  f\textsubscript{Y}(y) = \ensuremath{\int}\textsubscript{0}\textsuperscript{\ensuremath{\infty}} 2e\textsuperscript{-x}e\textsuperscript{-2y} dx = 2e\textsuperscript{-2y} \ensuremath{\cdot} [1] = 2e\textsuperscript{-2y} \ensuremath{\to} Y \textasciitilde{} Exp(2)
\end{itemize}
...
\tightlist
\item
  f\textsubscript{X,Y}(x,y) = 2e\textsuperscript{-x}\ensuremath{\cdot}e\textsuperscript{-2y} = [e\textsuperscript{-x}]\ensuremath{\cdot}[2e\textsuperscript{-2y}] \PSyes{} Independent!
\item
