...
\textbf{Axiom 3 (Countable Additivity):}\PSbr{}For mutually exclusive events A\textsubscript{1}, A\textsubscript{2}, A\textsubscript{3}, …:\PSdisplay{P(A_1 \cup A_2 \cup A_3 \cup \cdots) = P(A_1) + P(A_2) + P(A_3) + \cdots}
...
For mutually exclusive events (A \ensuremath{\cap} B = \ensuremath{\emptyset}):\PSdisplay{P(A \cup B) = P(A) + P(B)}
