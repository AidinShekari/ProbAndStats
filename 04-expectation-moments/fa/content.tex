...
\tightlist
\item
  \textbf{پردازش سیگنال:} توان میانگین چقدر است؟ \lr{\mbox{\ensuremath{\to}}} میانگین \lr{\mbox{X\textsuperscript{2}}}
\item
  \textbf{کنترل کیفیت:} قطعات چقدر تغییر می‌کنند؟ \lr{\mbox{\ensuremath{\to}}} واریانس
\item
  \textbf{مخابرات:} توان نویز چقدر است؟ \lr{\mbox{\ensuremath{\to} E[N\textsuperscript{2}]}}
\item
...
مقدار امید ریاضی همان \textbf{میانگین درازمدت} است: اگر آزمایش را بارها تکرار کنید و نتایج را میانگین بگیرید، مقدار تقریبی \lr{\mbox{E[X]}} به دست می‌آید.
...
\bottomrule\noalign{}
\endlastfoot
ولتاژ نویز \lr{\mbox{E[N]}} & بایاس/آفست \lr{\mbox{DC}} در نویز \\
دامنه سیگنال \lr{\mbox{E[A]}} & سطح میانگین سیگنال \\
عمر قطعه \lr{\mbox{E[T]}} & میانگین زمان تا خرابی \lr{\mbox{(MTTF)}} \\
تأخیر بسته \lr{\mbox{E[D]}} & تأخیر میانگین \\
خطاهای بیت \lr{\mbox{E[X]}} & تعداد خطای میانگین \\
\end{longtable}
}
...
\tightlist
\item
  \lr{\mbox{E[N] = 0}} (بدون مؤلفه \lr{\mbox{DC}})
\item
...
پروتکل \lr{\mbox{ARQ}}: هر انتقال با احتمال \lr{\mbox{p = 0.8}} موفق است.\PSbr{}تعداد تلاش‌ها \lr{\mbox{X \textasciitilde{} Geometric(0.8)}}.\PSbr{}\lr{\mbox{E[X] = 1/p = 1/0.8 = 1.25}} تلاش به‌طور میانگین.

\end{PSbox}

\PSsection{4.3}{مقدار امید ریاضی یک تابع: \lr{\mbox{E[g(X)]}}}

\begin{PSbox}[unbreakable]{thm}{قضیه \lr{\mbox{LOTUS}} (قانون آماردان ناخودآگاه)}

برای یافتن \lr{\mbox{E[g(X)]}}، نیازی به توزیع \lr{\mbox{Y = g(X)}} ندارید:
...
\begin{longtable}[c]{@{}cc@{}}
\toprule\noalign{}
\rowcolor{PSnavy}\PSth{تابع \lr{\mbox{g(X)}}} & \PSth{معنای مهندسی} \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
\lr{\mbox{g(X) = X\textsuperscript{2}}} & مقدار میانگین مربع (توان) \\
\lr{\mbox{g(X) = (X - \ensuremath{\mu})\textsuperscript{2}}} & واریانس (توان \lr{\mbox{AC}}) \\
\lr{\mbox{g(X) =}} & \lr{\mbox{X}} \\
\lr{\mbox{g(X) = e\textsuperscript{j\ensuremath{\omega}X}}} & تابع مشخصه \\
\end{longtable}
}

\begin{PSbox}[unbreakable]{ex}{مثال: توان میانگین یک سیگنال}

سیگنال \lr{\mbox{X}} دارای \lr{\mbox{PDF f\textsubscript{X}(x)}} است. توان \lr{\mbox{P = X\textsuperscript{2}}}.

\lr{E[P] = E[X\textsuperscript{2}] = \ensuremath{\int} x\textsuperscript{2} f\textsubscript{X}(x) dx}

برای \lr{X \textasciitilde{} N(0, \ensuremath{\sigma}\textsuperscript{2})}: \lr{E[X\textsuperscript{2}] = \ensuremath{\sigma}\textsuperscript{2}} (توان نویز برابر واریانس است).

برای \lr{X \textasciitilde{} N(\ensuremath{\mu}, \ensuremath{\sigma}\textsuperscript{2})}: \lr{E[X\textsuperscript{2}] = \ensuremath{\mu}\textsuperscript{2} + \ensuremath{\sigma}\textsuperscript{2}} (توان کل = توان \lr{\mbox{DC}} + توان \lr{\mbox{AC}}).
...
برای یک سیگنال با میانگین صفر \lr{\mbox{X}}:
...
\item
  برای \lr{X \textasciitilde{} N(0, \ensuremath{\sigma}\textsuperscript{2})}: توان نویز = \lr{\mbox{\ensuremath{\sigma}\textsuperscript{2} = Var(X)}}
\end{itemize}

برای یک سیگنال با آفست \lr{\mbox{DC (\ensuremath{\mu} \ensuremath{\neq} 0)}}:

\begin{itemize}
\tightlist
\item
  \lr{E[X\textsuperscript{2}] = \ensuremath{\mu}\textsuperscript{2} + \ensuremath{\sigma}\textsuperscript{2}} = \textbf{توان کل = توان \lr{\mbox{DC}} + توان \lr{\mbox{AC}}}
\item
  \lr{\mbox{Var(X) = \ensuremath{\sigma}\textsuperscript{2}}} = \textbf{فقط توان \lr{\mbox{AC}}}
\end{itemize}
...
انحراف معیار \textbf{همان یکای} \lr{\mbox{X}} را دارد و بنابراین مستقیماً قابل تفسیر است:
...
اگر همواره \lr{\mbox{X \ensuremath{\ge} 0}} باشد، آنگاه \lr{\mbox{E[X] \ensuremath{\ge} 0}}.

اگر همواره \lr{\mbox{X \ensuremath{\ge} Y}} باشد، آنگاه \lr{\mbox{E[X] \ensuremath{\ge} E[Y]}}.

\PSsubsection{برای متغیرهای تصادفی مستقل}

اگر \lr{\mbox{X}} و \lr{\mbox{Y}} مستقل باشند:\PSdisplay{E[XY] = E[X] \cdot E[Y]}
...
یک سیگنال دریافتی: \lr{\mbox{R = S + N\textsubscript{1} + N\textsubscript{2}}} (سیگنال به‌همراه دو منبع نویز)
...
\tightlist
\item
  افزودن ثابت \lr{\mbox{b}} واریانس را تغییر نمی‌دهد (انتقال، پراکندگی را تغییر نمی‌دهد)
\item
  مقیاس‌بندی با \lr{\mbox{a}}، واریانس را در \lr{\mbox{a\textsuperscript{2}}} ضرب می‌کند
\end{itemize}

\PSsubsection{جمع متغیرهای تصادفی مستقل}

اگر \lr{\mbox{X\textsubscript{1}}}، \lr{\mbox{X\textsubscript{2}}}، \lr{…}، \lr{\mbox{X\textsubscript{n}}} \textbf{مستقل} باشند:
...
توان نویز کل = \lr{\ensuremath{\sigma}\textsubscript{1}\textsuperscript{2} + \ensuremath{\sigma}\textsubscript{2}\textsuperscript{2} = 0.05 V\textsuperscript{2}}\PSbr{}نویز مؤثر کل = \lr{\mbox{\ensuremath{\surd}0.05 = 0.224 V}}

توجه: مقادیر مؤثر \lr{\mbox{(RMS)}} مستقیماً جمع نمی‌شوند! \lr{\mbox{(0.1 + 0.2 \ensuremath{\neq} 0.224)}}

\end{PSbox}

\PSsubsection{واریانس میانگین نمونه}

برای \lr{\mbox{n}} مشاهده مستقل و هم‌توزیع \lr{\mbox{(i.i.d.) X\textsubscript{1}}}، \lr{…}، \lr{\mbox{X\textsubscript{n}}} با واریانس \lr{\mbox{\ensuremath{\sigma}\textsuperscript{2}}}:
...
\PSsubsection{گشتاور مرتبه \lr{\mbox{n}}}

\PSdisplay{\mu_n' = E[X^n] = \int_{-\infty}^{\infty} x^n f_X(x) \, dx}

\PSsubsection{گشتاور مرکزی مرتبه \lr{\mbox{n}}}
...
\tightlist
\item
  \lr{\mbox{\ensuremath{\mu}\textsubscript{1} = 0}} (همیشه)
\item
  \lr{\mbox{\ensuremath{\mu}\textsubscript{2} = Var(X)}}
\item
  \lr{\mbox{\ensuremath{\mu}\textsubscript{3}}} به \textbf{چولگی} مربوط است
\item
  \lr{\mbox{\ensuremath{\mu}\textsubscript{4}}} به \textbf{کشیدگی} مربوط است
\end{itemize}
...
\bottomrule\noalign{}
\endlastfoot
\lr{\mbox{\ensuremath{\gamma}\textsubscript{1} = 0}} & متقارن & گاوسی \\
\lr{\mbox{\ensuremath{\gamma}\textsubscript{1} \textgreater{} 0}} & چوله به راست (دنباله بلند در راست) & نمایی \\
\lr{\mbox{\ensuremath{\gamma}\textsubscript{1} \textless{} 0}} & چوله به چپ (دنباله بلند در چپ) & نمایی منفی‌شده \\
\end{longtable}
}
...
\bottomrule\noalign{}
\endlastfoot
\lr{\mbox{\ensuremath{\gamma}\textsubscript{2} = 0}} & مزوکورتیک & دنباله‌هایی شبیه گاوسی \\
\lr{\mbox{\ensuremath{\gamma}\textsubscript{2} \textgreater{} 0}} & لپتوکورتیک & دنباله‌های سنگین‌تر از گاوسی \\
\lr{\mbox{\ensuremath{\gamma}\textsubscript{2} \textless{} 0}} & پلاتی‌کورتیک & دنباله‌های سبک‌تر از گاوسی \\
\end{longtable}
}
...
گشتاور مرتبه \lr{\mbox{n}} با \lr{\mbox{n}} بار مشتق‌گیری در \lr{\mbox{t = 0}} به دست می‌آید:
...
\tightlist
\item
  \lr{\mbox{M\textsubscript{X}’(0) = E[X]}}
\item
  \lr{\mbox{M\textsubscript{X}’’(0) = E[X\textsuperscript{2}]}}
\item
...
\def\labelenumi{\arabic{enumi}.}
\item
  \textbf{یگانگی:} اگر \lr{\mbox{M\textsubscript{X}(t) = M\textsubscript{Y}(t)}} برای تمام \lr{\mbox{t}} در همسایگی 0 برقرار باشد، آنگاه \lr{\mbox{X}} و \lr{\mbox{Y}} توزیع یکسانی دارند.
\item
  \textbf{جمع متغیرهای تصادفی مستقل:} اگر \lr{\mbox{X}} و \lr{\mbox{Y}} مستقل باشند:\PSbr{}\lr{M\textsubscript{X+Y}(t) = M\textsubscript{X}(t) \ensuremath{\cdot} M\textsubscript{Y}(t)}
\item
...
\begin{longtable}[c]{@{}cc@{}}
\toprule\noalign{}
\rowcolor{PSnavy}\PSth{توزیع} & \PSth{\lr{\mbox{MGF}} یعنی \lr{\mbox{M\textsubscript{X}(t)}}} \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
\endlastfoot
\lr{\mbox{Bernoulli(p)}} & \lr{\mbox{1 - p + pe\textsuperscript{t}}} \\
\lr{\mbox{Binomial(n,p)}} & \lr{\mbox{(1 - p + pe\textsuperscript{t})\textsuperscript{n}}} \\
\lr{\mbox{Poisson(\ensuremath{\lambda})}} & \lr{\mbox{exp(\ensuremath{\lambda}(e\textsuperscript{t} - 1))}} \\
\lr{\mbox{Exponential(\ensuremath{\lambda})}} & \lr{\mbox{\ensuremath{\lambda}/(\ensuremath{\lambda} - t)}}، \lr{\mbox{t \textless{} \ensuremath{\lambda}}} \\
...
این همان \lr{\mbox{MGF}} توزیع \lr{N(\ensuremath{\mu}\textsubscript{1}+\ensuremath{\mu}\textsubscript{2}, \ensuremath{\sigma}\textsubscript{1}\textsuperscript{2}+\ensuremath{\sigma}\textsubscript{2}\textsuperscript{2})} است. بنابراین \lr{X\textsubscript{1}+X\textsubscript{2} \textasciitilde{} N(\ensuremath{\mu}\textsubscript{1}+\ensuremath{\mu}\textsubscript{2}, \ensuremath{\sigma}\textsubscript{1}\textsuperscript{2}+\ensuremath{\sigma}\textsubscript{2}\textsuperscript{2})}.

\PSsection{4.10}{کاربردهای مهندسی گشتاورها}

\PSsubsection{کاربرد 1: مشخصه‌سازی توان نویز}

یک سیگنال نویز \lr{\mbox{N(t)}} نمونه‌برداری می‌شود. نمونه‌ها میانگین \lr{\mbox{\ensuremath{\mu}\textsubscript{N}}} و واریانس \lr{\mbox{\ensuremath{\sigma}\textsubscript{N}\textsuperscript{2}}} دارند.

\begin{itemize}
\tightlist
\item
  \textbf{مؤلفه \lr{\mbox{DC}} (بایاس):} \lr{\mbox{\ensuremath{\mu}\textsubscript{N}}} \lr{—} برای نویز ایده‌آل باید صفر باشد
\item
  \textbf{توان نویز \lr{\mbox{AC}}:} \lr{\mbox{\ensuremath{\sigma}\textsubscript{N}\textsuperscript{2}}} \lr{—} تعیین‌کننده \lr{\mbox{SNR}}
\item
...
یک حسگر مقدار واقعی \lr{\mbox{\ensuremath{\theta}}} را با خطای \lr{\mbox{E}} اندازه‌گیری می‌کند:

\begin{itemize}
\tightlist
\item
  اندازه‌گیری: \lr{\mbox{X = \ensuremath{\theta} + E}}
\item
  \lr{\mbox{E[X] = \ensuremath{\theta} + E[E]}} \lr{—} بایاس در اندازه‌گیری
\item
  \lr{\mbox{Var(X) = Var(E)}} \lr{—} دقت اندازه‌گیری
\end{itemize}

\textbf{صحّت:} \lr{\mbox{\textbar{}E[E]\textbar{}}} (میانگین چقدر به مقدار واقعی نزدیک است)\PSbr{}\textbf{دقت (تکرارپذیری):} \lr{\mbox{\ensuremath{\sigma}\textsubscript{E}}} (اندازه‌گیری‌ها چقدر تکرارپذیر هستند)

\PSsubsection{کاربرد 3: آماره‌های عمر قطعه}

قطعات عمر \lr{\mbox{T \textasciitilde{} Exponential(\ensuremath{\lambda})}} دارند:

\begin{itemize}
\tightlist
\item
  میانگین زمان تا خرابی: \lr{\mbox{MTTF = E[T] = 1/\ensuremath{\lambda}}}
\item
  انحراف معیار: \lr{\ensuremath{\sigma}\textsubscript{T} = 1/\ensuremath{\lambda} = MTTF}
\item
  برای نمایی: ضریب تغییرات \lr{\mbox{CV = \ensuremath{\sigma}/\ensuremath{\mu} = 1}} (همیشه!)
\end{itemize}

\PSsubsection{کاربرد 4: دامنه سیگنال مخابراتی}

سیگنال دریافتی \lr{\mbox{R = A + N}} که در آن \lr{\mbox{A}} = دامنه سیگنال و \lr{N \textasciitilde{} N(0, \ensuremath{\sigma}\textsuperscript{2})}:

\begin{itemize}
\tightlist
\item
  \lr{\mbox{E[R] = A}} (دامنه سیگنال به‌طور میانگین حفظ می‌شود)
\item
  \lr{\mbox{Var(R) = \ensuremath{\sigma}\textsuperscript{2}}} (توان نویز واریانس را تعیین می‌کند)
\item
...
یک متغیر تصادفی گسسته \lr{\mbox{X}} دارای \lr{\mbox{PMF}} زیر است: \lr{\mbox{P(X=-1) = 0.2}}، \lr{\mbox{P(X=0) = 0.5}}، \lr{\mbox{P(X=1) = 0.2}}، \lr{\mbox{P(X=2) = 0.1}}.

\begin{enumerate}
\def\labelenumi{(\PSalph{enumi})}
\tightlist
\item
  \lr{\mbox{E[X]}} را بیابید.
\item
  \lr{\mbox{E[X\textsuperscript{2}]}} را بیابید.
\item
  \lr{\mbox{Var(X)}} را بیابید.
\item
  \lr{\mbox{E[3X + 2]}} را بیابید.
\item
  \lr{\mbox{Var(3X + 2)}} را بیابید.
\end{enumerate}
...
\item
  \lr{\mbox{E[3X + 2] = 3E[X] + 2 = 3(0.2) + 2 = 2.6}}
\item
  \lr{\mbox{Var(3X + 2) = 9\ensuremath{\cdot}Var(X) = 9(0.76) = 6.84}}
\end{enumerate}
...
یک سیگنال دریافتی \lr{\mbox{R = 2.5 + N}} که در آن \lr{\mbox{N \textasciitilde{} N(0, 0.04)}}.

\begin{enumerate}
\def\labelenumi{(\PSalph{enumi})}
\tightlist
\item
  \lr{\mbox{E[R]}} و \lr{\mbox{Var(R)}} را بیابید.
\item
  \lr{\mbox{SNR}} را بر حسب \lr{\mbox{dB}} بیابید.
\item
  \lr{\mbox{P(R \textless{} 0)}} را بیابید \lr{—} احتمال این‌که سیگنال منفی شود.
\end{enumerate}
...
\def\labelenumi{(\PSalph{enumi})}
\item
  \lr{\mbox{E[R] = 2.5}}، \lr{\mbox{Var(R) = Var(N) = 0.04}}، \lr{\mbox{\ensuremath{\sigma}\textsubscript{R} = 0.2}}
\item
  توان سیگنال = \lr{\mbox{2.5\textsuperscript{2} = 6.25}}، توان نویز = \lr{\mbox{0.04}}\PSbr{}\lr{SNR = 6.25/0.04 = 156.25 \ensuremath{\to} SNR\textsubscript{dB} = 10\ensuremath{\cdot}log\textsubscript{10}(156.25) = 21.94 dB}
\item
...
یک حسگر \lr{\mbox{n}} اندازه‌گیری مستقل از یک ولتاژ ثابت \lr{\mbox{V = 3.3V}} انجام می‌دهد.\PSbr{}هر اندازه‌گیری: \lr{\mbox{X\textsubscript{i} = 3.3 + N\textsubscript{i}}} که در آن \lr{\mbox{N\textsubscript{i} \textasciitilde{} N(0, 0.01)}}.

\begin{enumerate}
\def\labelenumi{(\PSalph{enumi})}
\tightlist
\item
  برای \lr{\mbox{n = 1}} مقدار \lr{\mbox{E[\ensuremath{\bar{X}}]}} و \lr{\mbox{Var(\ensuremath{\bar{X}})}} چقدر است؟
\item
  چه تعداد اندازه‌گیری \lr{\mbox{n}} لازم است تا \lr{\mbox{\ensuremath{\sigma}\textsubscript{X}̄ \textless{} 0.01V}} شود؟
\item
  با \lr{\mbox{n = 100}}، مقدار \lr{P(\textbar{}\ensuremath{\bar{X}} - 3.3\textbar{} \textgreater{} 0.02)} چقدر است؟
\end{enumerate}
...
\def\labelenumi{(\PSalph{enumi})}
\item
  \lr{\mbox{E[\ensuremath{\bar{X}}] = 3.3}}، \lr{\mbox{Var(\ensuremath{\bar{X}}) = 0.01/1 = 0.01}}، \lr{\mbox{\ensuremath{\sigma} = 0.1V}}
\item
  \lr{\ensuremath{\sigma}\textsubscript{X}̄ = \ensuremath{\sigma}/\ensuremath{\surd}n \textless{} 0.01 \ensuremath{\to} \ensuremath{\surd}n \textgreater{} 10 \ensuremath{\to} n \textgreater{} 100 \ensuremath{\to}} به \lr{\mbox{n \ensuremath{\ge} 101}} نیاز است
\item
...
\tightlist
\item
  \lr{\mbox{MTTF}}، \lr{\mbox{\ensuremath{\sigma}\textsubscript{T}}} و ضریب تغییرات را بیابید.
\item
  \lr{\mbox{P(T \textgreater{} 1000 \rl{ساعت})}} را بیابید.
\item
  \lr{\mbox{E[T\textsuperscript{2}]}} را بیابید و تفسیر کنید.
\end{enumerate}
...
\def\labelenumi{(\PSalph{enumi})}
\item
  \lr{\mbox{MTTF = 1/\ensuremath{\lambda} = 500}} ساعت، \lr{\mbox{\ensuremath{\sigma}\textsubscript{T} = 500}} ساعت، \lr{\mbox{CV = \ensuremath{\sigma}/\ensuremath{\mu} = 1}}
\item
  \lr{P(T \textgreater{} 1000) = e\textsuperscript{-0.002\ensuremath{\times}1000} = e\textsuperscript{-2} = 0.1353}
\item
  \lr{E[T\textsuperscript{2}] = Var(T) + (E[T])\textsuperscript{2} = 500\textsuperscript{2} + 500\textsuperscript{2} = 500000 hours\textsuperscript{2}}\PSbr{}\lr{\mbox{\ensuremath{\surd}E[T\textsuperscript{2}] = 707}} ساعت (عمر مؤثر)
\end{enumerate}
...
\lr{\mbox{X}} دارای \lr{\mbox{MGF}} زیر است: \lr{M\textsubscript{X}(t) = (1/3)e\textsuperscript{t} + (2/3)e\textsuperscript{2t}}.

\begin{enumerate}
\def\labelenumi{(\PSalph{enumi})}
\tightlist
\item
  \lr{\mbox{X}} چه نوع متغیر تصادفی است؟ \lr{\mbox{PMF}} آن را بیابید.
\item
  با استفاده از \lr{\mbox{MGF}} مقدار \lr{\mbox{E[X]}} را بیابید.
\item
  با استفاده از \lr{\mbox{MGF}} مقدار \lr{\mbox{Var(X)}} را بیابید.
\end{enumerate}
...
\def\labelenumi{(\PSalph{enumi})}
\item
  \lr{\mbox{X}} گسسته است. با مقایسه با \lr{\ensuremath{\Sigma} p\textsubscript{X}(x)e\textsuperscript{tx}}:\PSbr{}\lr{\mbox{P(X=1) = 1/3}}، \lr{\mbox{P(X=2) = 2/3}}
\item
  \lr{M’(t) = (1/3)e\textsuperscript{t} + (4/3)e\textsuperscript{2t}}\PSbr{}\lr{\mbox{E[X] = M’(0) = 1/3 + 4/3 = 5/3}}
\item
  \lr{M’«\lr{(t) = (1/3)e\textsuperscript{t} + (8/3)e\textsuperscript{2t}}\PSbr{}\lr{\mbox{E[X\textsuperscript{2}] = M}}»’(0) = 1/3 + 8/3 = 3}\PSbr{}\lr{\mbox{Var(X) = 3 - (5/3)\textsuperscript{2} = 3 - 25/9 = 2/9}}
\end{enumerate}
...
\tightlist
\item
  \textbf{\lr{\mbox{E[X]}} = میانگین درازمدت} \lr{—} مرکز توزیع، مؤلفه \lr{\mbox{DC}}
\item
  \textbf{\lr{\mbox{Var(X)}} = پراکندگی/توان} \lr{—} برای سیگنال‌های با میانگین صفر، واریانس همان توان است
\item
  \textbf{\lr{\mbox{\ensuremath{\sigma}}} همان یکای \lr{\mbox{X}} را دارد} \lr{—} مستقیماً به‌عنوان مقدار مؤثر \lr{\mbox{(RMS)}} قابل تفسیر است
\item
